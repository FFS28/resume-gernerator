...
class StatementService
{
    ...
    private $negativSearches = [
        ...
        Operation::TYPE_OTHER => [
            ...
            "FINANCES PUBLIQUES" => ["Etat", "Impots"],
    ...
    public function extractOperations(Statement $statement)
    {
        ...
        $positivLabels = array_merge($this->positivSearches[Operation::TYPE_INCOME],
            $this->positivSearches[Operation::TYPE_REFUND]);
    ...
    public function analyseOperation(Operation $operation)
    {
        ...
        if ($operation->getAmount() > 0) {
            foreach ($this->positivSearches as $indexType => $searchesType) {
                foreach ($searchesType as $searchOperation) {
            ...
            foreach ($this->negativSearches as $indexType => $searchesType) {
